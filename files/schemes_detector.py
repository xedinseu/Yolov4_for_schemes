...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(504, 156)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(10, 10, 481, 71))
        font = QtGui.QFont()
        ...
        self.file_Button.setGeometry(QtCore.QRect(320, 100, 75, 23))
        self.file_Button.setObjectName("file_Button")
        self.go_Button = QtWidgets.QPushButton(self.centralwidget)
        self.go_Button.setGeometry(QtCore.QRect(410, 100, 75, 23))
        self.go_Button.setObjectName("go_Button")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(20, 100, 280, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.file_Button.setText(_translate("MainWindow", "Обзор"))
        self.go_Button.setText(_translate("MainWindow", "Распознать"))

    def actions_on_buttons(self):
      self.file_Button.clicked.connect(lambda: self.select_file())
      self.go_Button.clicked.connect(lambda: self.go())
    
    def select_file(self):
      ui.label_2.setText(QtWidgets.QFileDialog.getOpenFileName()[0])

    def go(self):
      file = ui.label_2.text()
      self.label.setText("Идет обработка изображения")
      ...
      self.label.setText("Обработка закончена, результаты сохранены в файл на вашем ПК")
...
cd ..
''')
ui.label.setText("Выберите файл для распознавания")
sys.exit(app.exec_())
